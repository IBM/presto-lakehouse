...
| [Lab 2: Create & Query Iceberg Tables](lab-2/README.md) | Create Iceberg tables and explore them in MinIO and Presto |
| [Lab 3: Create & Query Basic Hudi Tables](lab-3/README.md) | Set up Hudi tables from the `spark-shell` and explore them in MinIO and Presto |
| [Lab 4: Explore Hudi Table & Query Types](lab-4/README.md) | Explore how to create and interact with different types of Hudi tables and queries (intermediate-level concepts) |
